...
namespace ejercicio3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese la opción del procesador:");
            procesador = int.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese la opción de memoria RAM:");
            ram = int.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese la opción del disco:");
            ...
            Console.WriteLine("El precio es de USD" + precio.ToString("0.00"));
        }
    }
}
